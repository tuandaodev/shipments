  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url(); ?>" class="logo">
        ...
        <span class="logo-lg"><b>Ems Manager</b></span>
      </a>
        ...
        <?php if ($this->router->fetch_class() == 'shipments') {
          ...
          <form class="navbar-form navbar-left" method="POST">
              <div class="form-group">
                <select class="form-control" id="selected_marchant_token" name="selected_marchant_token" onchange="this.form.submit()" >
                      <option value="">Chọn token...</option>
                      <?php foreach ($merchant_token_list as $item) {
                          echo "<option value='{$item['id']}'" . ($item['id'] == $this->session->userdata('selected_marchant_token') ? 'selected' : '')  . ">{$item['name']}</option>";
                      }
                      ?>
                  </select>
              </div>
